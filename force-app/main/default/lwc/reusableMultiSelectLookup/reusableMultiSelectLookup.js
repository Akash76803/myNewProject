...
import retriveSearchData from '@salesforce/apex/ContactMultiSelectLookupController.retriveSearchData';

export default class ReusableMultiSelectLookup extends LightningElement {
    @api objectname = 'Account';
    @api fieldnames = ' Id, Name ';
    @api accountidfromchild ;
    @api Label;
    @track searchRecords = [];
    ...
    searchField() {
        ...
        retriveSearchData({ ObjectName: this.objectname, fieldName: this.fieldnames, value: this.searchKey, selectedRecId: selectedRecordIds, accoid: this.accountidfromchild })
            .then(result => {
